    ...
    <Container maxWidth="sm" className="App">
      <Paper>
        ...
        <Button variant="contained" color="primary" startIcon={<Avatar src={discordLogo} variant="rounded"/>} 
          href="https://discord.com/api/oauth2/authorize?client_id=797767418285260802&redirect_uri=https%3A%2F%2Fwacky.kikkia.dev%2Fauth&response_type=code&scope=identify">
          Signin with Discord
        </Button>
      </Paper>
    </Container>
